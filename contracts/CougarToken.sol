...
contract CougarToken is BEP20 {
    ...
    // Min amount to liquify. (default 500 COUGARs)
     ...
     */
    constructor() public BEP20("CougarSwap Token", "CGS") {
     ...
     * Can only be called by the current operator.
     */
    function updateCougarSwapRouter(address _router) public onlyOperator {
